...
public:
      ...
      BOOST_ASIO_MOVE_ARG(HandshakeHandler) handler)
  {
    ...
    BOOST_ASIO_HANDSHAKE_HANDLER_CHECK(HandshakeHandler, handler) type_check _UNUSED;
  ...
  async_shutdown(BOOST_ASIO_MOVE_ARG(ShutdownHandler) handler)
  {
    ...
    BOOST_ASIO_SHUTDOWN_HANDLER_CHECK(ShutdownHandler, handler) type_check _UNUSED;
      ...
      BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    BOOST_ASIO_WRITE_HANDLER_CHECK(WriteHandler, handler) type_check _UNUSED;
