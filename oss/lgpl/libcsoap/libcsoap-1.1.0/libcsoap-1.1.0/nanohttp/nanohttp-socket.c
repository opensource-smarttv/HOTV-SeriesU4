/******************************************************************
*  $Id: nanohttp-socket.c 141329 2012-01-24 09:27:11Z kutterol $
*
...
----------------------------------------------------------*/
herror_t
hsocket_accept(hsocket_t * sock, hsocket_t * dest, int ssl)
{
  herror_t status;
  ...
  log_verbose4("accepting connection from '%s' socket=%d ssl=%d",
