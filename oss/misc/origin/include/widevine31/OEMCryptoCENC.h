...
OEMCryptoResult OEMCrypto_DecryptLevelOneVideo(OEMCrypto_SESSION session,
                                  void *crypto,
...
OEMCryptoResult OEMCrypto_DecryptLevelOneAudio(OEMCrypto_SESSION session,
                                   void *crypto,
                                   size_t crypto_length,
                                   unsigned char *in_buf,
                                   size_t buf_length,
                                   void *pstTEE_Audio_Info,
                                   size_t is_encrypt,
                                   unsigned char *key_id,
                                   size_t key_id_length,
                                   unsigned char *iv);
