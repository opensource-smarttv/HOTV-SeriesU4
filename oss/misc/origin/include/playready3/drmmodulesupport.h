...
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_M2TS_IsM2TSEncryptorSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_M2TS_IsM2TSEncryptorUnsupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
...
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_MOVE_IsMoveSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
...
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_PRND_IsPRNDSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_PRND_IsPRNDUnsupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_PRND_IsPRNDTransmitterSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_PRND_IsPRNDTransmitterUnsupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_PRND_IsPRNDReceiverSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_PRND_IsPRNDReceiverUnsupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
...
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_CLK_IsSecureClockSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_CLK_IsSecureClockUnsupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;

DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_CLK_IsSecureClockExternSupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API DRM_BOOL DRM_CALL DRM_CLK_IsSecureClockExternUnsupported( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
