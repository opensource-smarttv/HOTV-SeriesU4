...
#define PREFAST_PUSH_IGNORE_NONCONST_PARAMS_FOR_STUB_IMPL                                                                                                                       \
    PREFAST_PUSH_DISABLE_EXPLAINED( __WARNING_NONCONST_PARAM_25004, "Changing parameters to const to satisfy warning would make them not match the real interface." )           \
    PREFAST_PUSH_DISABLE_EXPLAINED( __WARNING_NONCONST_BUFFER_PARAM_25033, "Changing parameters to const to satisfy warning would make them not match the real interface." )
...
// disable this on MStar secure process
#ifdef AEON
...
//Disable the optimize option
//#pragma GCC target is not supported for this machine [-Werror=pragmas]
