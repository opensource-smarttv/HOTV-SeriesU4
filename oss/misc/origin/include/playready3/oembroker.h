...
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL Oem_Broker_CRITSEC_Uninitialize( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL Oem_Broker_CRITSEC_Enter( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL Oem_Broker_CRITSEC_Leave( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
