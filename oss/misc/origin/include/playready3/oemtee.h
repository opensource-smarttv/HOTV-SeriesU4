...
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL OEM_TEE_LPROV_UnprotectLeafCertificatePrivateKeys(
    ...
    __inout_opt                                                                       OEM_TEE_KEY       *f_pLeafCertificatePrivatePRNDEncryptionKey ) DRM_NO_INLINE_ATTRIBUTE;
...
// MSTAR patch
DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL OEM_TEE_AES128CTR_DecryptContentOPTEE(
    __inout                                         OEM_TEE_CONTEXT                 *f_pContext,
    __in                                            DRM_TEE_POLICY_INFO_CALLING_API  f_ePolicyCallingAPI,
    __in                                      const DRM_TEE_POLICY_INFO             *f_pPolicy,
    __in                                      const OEM_TEE_KEY                     *f_pCK,
    ...
    __out                                           DRM_DWORD                       *f_ui32KeyIndex ) DRM_NO_INLINE_ATTRIBUTE;


DRM_NO_INLINE DRM_API DRM_RESULT DRM_CALL OEM_TEE_AES128CTR_DecryptContentR2TEE(
    __inout                                         OEM_TEE_CONTEXT                 *f_pContext,
    __in                                            DRM_TEE_POLICY_INFO_CALLING_API  f_ePolicyCallingAPI,
    __in                                      const DRM_TEE_POLICY_INFO             *f_pPolicy,
    __in                                      const OEM_TEE_KEY                     *f_pCK,
...
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL OEM_TEE_BASE_CRITSEC_Uninitialize( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL OEM_TEE_BASE_CRITSEC_Enter( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
DRM_NO_INLINE DRM_API_VOID DRM_VOID DRM_CALL OEM_TEE_BASE_CRITSEC_Leave( DRM_VOID ) DRM_NO_INLINE_ATTRIBUTE;
