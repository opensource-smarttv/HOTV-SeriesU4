...
DRM_RESULT DRM_CALL DRM_XMB_HashAndRSASignAndCloseCurrNodeA(
    __inout                                              _XMBContextA                *f_pbContextXMLA,
    __in                                                 OEM_SHA1_CONTEXT            *f_pcontextSHA,
    __in                                           const DRM_RSA_PRIVATE_KEY_2048BIT *f_pprivkeyRSA,
    __in                                                 DRM_BOOL                     f_fIncludeTag,
    __out_bcount(OEM_SHA1_DIGEST_LEN)                    DRM_BYTE                     f_rgbSHA  [ OEM_SHA1_DIGEST_LEN ],
    __out_ecount(OEM_SHA1_B64ENC_DIGEST_LEN)             DRM_CHAR                     f_rgchSHA [ OEM_SHA1_B64ENC_DIGEST_LEN ],
