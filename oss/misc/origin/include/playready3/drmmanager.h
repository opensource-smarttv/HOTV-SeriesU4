...
// MSTAR add for software compatible
...
DRM_API DRM_RESULT DRM_CALL Drm_Reader_DecryptAudioContentMultiple(
    __in                                            DRM_DECRYPT_CONTEXT      *f_pDecryptContext,
...
/*
** ---------------------------------------
** MSTAR SVP API functions
** ---------------------------------------
*/

DRM_API DRM_RESULT DRM_CALL Drm_Reader_GenCryptoInfo(
    __in                                            DRM_DECRYPT_CONTEXT      *f_pDecryptContext,
    __in                                            DRM_DWORD                 f_cEncryptedRegionMappings,
    __in_ecount( f_cEncryptedRegionMappings ) const DRM_DWORD                *f_pdwEncryptedRegionMappings,
    __in                                            DRM_UINT64                f_ui64InitializationVector,
    ...
    __out                                           DRM_DWORD                *f_pcbOpaqueClearContent,
    __deref_out_bcount( *f_pcbOpaqueClearContent )  DRM_BYTE                **f_ppbOpaqueClearContent,
    __in                                            DRM_DWORD                 f_bKeyIndex );


DRM_API DRM_RESULT DRM_CALL DRM_CALL Drm_SVP_SetSecureVDECHandle(
    __inout                                         DRM_DECRYPT_CONTEXT      *f_pDecryptContext,
    __in                                            DRM_VOID                 *f_ppVdecHandle,
    __in                                            DRM_DWORD                 f_cbVdecHandle);

DRM_NO_INLINE DRM_API DRM_VOID DRM_CALL Drm_SVP_GetSvpStreamInfo(
    __out                                       DRM_BYTE **f_ppDrmHeader,
    __out                                       DRM_DWORD *f_pcbDrmHeader,
    __out                                       DRM_BYTE **f_ppEsSample,
    __out                                       DRM_DWORD *f_pcbEsSample,
    __in                                        DRM_BYTE *f_bpSvpStream,
    __in                                        DRM_DWORD f_cbSvpStream,
    __inout                                     DRM_DWORD *f_pbKeyIndex);

DRM_API DRM_RESULT DRM_CALL Drm_Reader_SecureMemCopy(
    __inout                                     DRM_VOID *pHandle,
    __in                                        DRM_BYTE* pbData,
