...
namespace TagLib {
  ...
  namespace ID3v2 {
    ...
    public:
       ...
       */
      UniqueFileIdentifierFrame(const ByteVector &data, uint frameDataPosition);

      /*!
       * Creates a unique file identifier frame with the owner \a owner and
       * the identification \a id.
       */
      UniqueFileIdentifierFrame(const String &owner, const ByteVector &id, uint frameDataPosition);
