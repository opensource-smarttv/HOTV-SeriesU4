...
namespace TagLib {
  ...
  namespace ID3v2 {
    ...
    public:
       ...
       * \a encoding.
       */
      explicit UnsynchronizedLyricsFrame(uint frameDataPosition, String::Type encoding = String::Latin1);

      /*!
       * Construct a unsynchronized lyrics frame based on the data in \a data.
       */
      explicit UnsynchronizedLyricsFrame(const ByteVector &data, uint frameDataPosition);
