...
namespace TagLib {
  ...
  namespace ID3v2 {
    ...
    public:
       ...
       */
      explicit AttachedPictureFrame(const ByteVector &data, uint frameDataPosition);
      ...
      /*!
       * Returns the offset inside the frame to the picture data
       */
      TagLib::uint pictureOffset() const;
