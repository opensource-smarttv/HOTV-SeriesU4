...
namespace TagLib {
  ...
  namespace ID3v2 {
    ...
    public:
       ...
       */
      Frame *createFrame(const ByteVector &data, uint frameDataPosition, bool synchSafeInts) const;
       ...
       * instance in new code.
       */
      Frame *createFrame(const ByteVector &data, uint frameDataPosition, uint version = 4) const;
       ...
       */
      // BIC: make virtual
      Frame *createFrame(const ByteVector &data, uint frameDataPosition, Header *tagHeader) const;
