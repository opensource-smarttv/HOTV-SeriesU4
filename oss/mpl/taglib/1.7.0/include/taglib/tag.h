...
namespace TagLib {
  ...
  public:
    ...
    /*!
     * Returns the number of pictures enclosed in this tag; if there is no
     * picture, this will return 0.
     */
    virtual uint numPictures() const;

    /*!
     * Returns the byte offset of the requested picture; if there is no picture
     * with this index, this will return 0.
     */
    virtual uint pictureOffset( uint index ) const;

    /*!
     * Returns the byte length of the requested picture; if there is no picture
     * with this index, this will return 0.
     */
    virtual uint pictureLength( uint index ) const;
