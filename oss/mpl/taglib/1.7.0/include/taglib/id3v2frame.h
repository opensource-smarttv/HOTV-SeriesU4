...
namespace TagLib {
  ...
  namespace ID3v2 {
    ...
    public:
      ...
      /*!
       * Returns the offset of the frame.
       */
      uint offset() const;
    ...
    protected:
       ...
       */
      explicit Frame(const ByteVector &data, uint frameDataPosition);
    ...
    public:
       ...
       * number.
       */
      Header(const ByteVector &data, uint frameDataPosition, bool synchSafeInts);
       ...
       */
      explicit Header(const ByteVector &data, uint frameDataPosition, uint version = 4);
      ...
      /*!
       * Set the absolute position in file of the frames data.
       */
      void setFrameDataPosition(uint frameDataPosition);
      ...
      /*!
       * Returns the absolute position in file of this frames data
       */
      uint frameDataPosition() const;
