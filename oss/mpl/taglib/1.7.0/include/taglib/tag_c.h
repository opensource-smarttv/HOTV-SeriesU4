...
/*!
 * Returns the number of pictures embedded in the tag.
 */
TAGLIB_C_EXPORT unsigned int taglib_tag_numPictures(const TagLib_Tag *tag);

/*!
 * Returns the picture offset of the picture with given index or 0 if no picture at this index.
 */
TAGLIB_C_EXPORT unsigned int taglib_tag_pictureOffset(const TagLib_Tag *tag, unsigned int index);

/*!
 * Returns the length of the picture with given index or 0 if no picture at this index.
 */
TAGLIB_C_EXPORT unsigned int taglib_tag_pictureLength(const TagLib_Tag *tag, unsigned int index);
